...
install_packages() {
    ...
    echo
    sudo apt install vim zsh screen ksshaskpass blender audacity vlc kdenlive gimp inkscape kdevelop clang clang-tidy cppcheck cmake cmake-gui git gitk kdiff3 net-tools
